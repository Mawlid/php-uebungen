    ...
      <div class="container-fluid">
        ...
            <ul class="nav navbar-nav">
            ...
                  <li><a href="index.php?menu=list">List</a></li>
                  <li class="active"><a href="index.php?menu=delete">Delete</a></li>
                </ul>
...
<div class="container">
    <div class="jumbotron">
        ...
        <form class="well form-horizontal" action="index.php" method="post">
                <h2 style="text-align: center;">Type in the user you want to delete</h2>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <button type="submit" name="delete" class="btn btn-warning">Delete<span class="glyphicon glyphicon-send"></span></button>
                </div>
            </div>
